...
# Vibration Support
TW_USE_VIBRATOR := true
TW_CUSTOM_VIBRATOR_PATH := /sys/devices/platform/soc/89c000.i2c/i2c-1/1-005a
TW_VIBRATOR_TIMEOUT_FILE := duration
TW_VIBRATOR_STATE_FILE := activate
TW_VIBRATOR_DEFAULT_TIMEOUT := 40